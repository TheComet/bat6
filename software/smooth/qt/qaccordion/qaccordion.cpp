...
QAccordion::QAccordion(QWidget *parent) : QWidget(parent)
{
    ...
    // not needed any more since this is no longer compiled as a library
    ...
    this->connect(this, SIGNAL(numberOfContentPanesChanged(int)), this, SLOT(numberOfPanesChanged(int)));
}
