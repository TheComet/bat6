...
Das  Kernst\"uck   des  Ger\"ates   besteht  aus  dem   CVCC  Spannungswandler
und   dem  Mikrocontroller. Der   Mikrocontroller   misst  Ausgangsstrom   und
Ausgangsspannung. Aus diesen Werten berechnet er Sollspannung und Strom. Durch
zwei  digital   einstellbare  Widerst\"ande  stellt  er   die  Spannungs-  und
Stromlimite des  Wandlers. Damit bildet er  die I-V Kennlinie  eines PV-Moduls
nach.
...
\begin{spreadtab}{{tabular}{llrrr}}
    ...
    @ H11N1SR2MCT-ND           & @ optocouplers                    & 5.94  & 2 & [-2,0] * [-1,0] \\
    @ 811-1673-5-ND            & @ DCDC isolated converter         & 7.95  & 1 & [-2,0] * [-1,0] \\
    @ 285-1829-ND              & @ ACDC 230V to 36V supply module  & 27.41 & 1 & [-2,0] * [-1,0] \\
    @ LTM8026EV\#PBF-ND        & @ CVCC buck converter, for output & 21.49 & 1 & [-2,0] * [-1,0] \\
    @ J151-ND                  & @ Banana Plugs                    & 0.70  & 2 & [-2,0] * [-1,0] \\
    @ TBD                      & @ Twistbutton                     & 10    & 1 & [-2,0] * [-1,0] \\
    @ TBD                      & @ Misc. components                & 20    & 1 & [-2,0] * [-1,0] \\
    \midrule
    @ \textbf{Subtotal}        & @                                 & @     & @ & sum(e2:e11)     \\
    \midrule
    @ Jackaltac                & @ Printed Circuit Board           & 40    & 1 & [-2,0] * [-1,0] \\
    @ TBD                      & @ Housing                         & 50    & 1 & [-2,0] * [-1,0] \\
    \midrule
    @ \textbf{Subtotal}        & @                                 & @     & @ & sum(e12:e14)    \\
    \bottomrule
\end{spreadtab}
\end{center}
