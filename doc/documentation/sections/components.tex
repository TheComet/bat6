...
und  ist  in  der Abbildung \ref{fig:circuit:mains-input} als  $N_2$  zu  sehen.
...
verrauscht sind und oder ungenau messen.
...
Verhalten der Spannungs\"anderung am Ausgang -- \"Uberschiessen der Spannung und
extreme Stromspitzen in der Spule k\"onnen vermieden werden.
...
Die Ausgangsspannung  kann  danach  durch Anheben des unteren Spannungspegels an
$R_2$   mit   einer    Analogen    Spannung   $BUCK\_USET$   nach   der   Formel
\ref{eq:circuit:buck:uset} ver\"andert werden.
...
Die   Schaltung   daf\"ur   ist  in  der  Abbildung  \ref{fig:circuit:buck:uset}
ersichtlich.
...
Ein Grund warum der LT3741 gew\"ahlt wurde ist wegen seiner CTRL1 Eingang. Durch
anlegen einer analogen Spannung  zwischen \SI{0}{\volt} und \SI{1.5}{\volt} kann
direkt der maximale \emph{Durchschnittsstrom}  durch  die  Spule $L_1$ und somit
der   maximale   Ausgangsstrom   eingestellt    werden.    In    der   Abbildung
\ref{fig:circuit:buck:iset}
